...
const dummyModules = [
  {
    ...
    assignments: [
      ...
      },
      {
        ...
        solvedBy: 513,
        solvedPercent: 94,
        link: "https://my.newtonschool.co/playground/code/3994ehvpxuju",
      },
      {
        id: 103,
        title: 'APIsmith Challenge #21: Size of resource',
        difficulty: 'hard',
        xp: 30,
        topics: ['Promises', 'JavaScript Array', 'JavaScript Object', 'Data Fetching using JS'],
        solvedBy: 269,
        solvedPercent: 85,
        link: "https://my.newtonschool.co/playground/code/jgh4g4fhivqo",
      },
      {
        id: 104,
        title: 'APIsmith Challenge #03:Average Marks for a Given Subject',
        difficulty: 'easy',
        xp: 10,
        topics: ['Promises', 'JavaScript Array', 'JavaScript Object', 'Data Fetching using JS'],
        solvedBy: 401,
        solvedPercent: 82,
        link: "https://my.newtonschool.co/playground/code/fs0ei61abnmb",
      },
    ],
  },
];
